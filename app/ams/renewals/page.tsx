    ...
    <div className="space-y-6">
      ...
      <form className="grid gap-3 rounded-lg border border-white/50 dark:border dark:border-white/[0.06] bg-white/45 dark:bg-[#252528] p-4 shadow-sm backdrop-blur-xl md:grid-cols-5">
        ...
        <div className="flex items-end gap-2">
          ...
          <Link className="rounded-lg border border-white/50 dark:border dark:border-white/[0.06] bg-white/30 dark:bg-white/[0.08] px-3 py-2 text-sm text-slate-700 dark:text-[#e8eaf0] transition-colors hover:bg-white/80 dark:hover:bg-white/[0.12]" href="/ams/renewals">
            Reset
          </Link>
        </div>
      </form>

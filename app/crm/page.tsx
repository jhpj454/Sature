...
export default async function CrmDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Revenue Chart */}
      <section
        className="rounded-2xl border border-white/50 dark:border dark:border-white/[0.06] bg-white/45 dark:bg-[#252528] p-5 backdrop-blur-xl dark:shadow-none"
      >
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <article
          className="rounded-2xl border border-white/50 dark:border dark:border-white/[0.06] bg-white/45 dark:bg-[#252528] p-6 backdrop-blur-xl dark:shadow-none"
        >
      ...
      {/* Recent Activity */}
      <section
        className="rounded-2xl border border-white/50 dark:border dark:border-white/[0.06] bg-white/45 dark:bg-[#252528] backdrop-blur-xl dark:shadow-none"
      >

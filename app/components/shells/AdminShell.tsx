...
function IconReports() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M4 11V8M7 11V6M10 11V4M13 11V7" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  )
}
...
const settingsNavItem: NavItem = { label: "Settings", href: "/admin/settings", icon: <IconGear /> }

...
function IconCustomers() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M13 9.5c1.657.5 2.8 1.9 2.8 3.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  )
}
...
const mainNavItems: NavItem[] = [
  { label: "Dashboard", href: "/ams", icon: <IconDashboard />, exact: true },
  { label: "Customers", href: "/ams/accounts", icon: <IconCustomers /> },
  { label: "Policies", href: "/ams/policies", icon: <IconPolicies /> },
  { label: "Service Cases", href: "/ams/service-cases", icon: <IconServiceCases /> },
  { label: "Renewals", href: "/ams/renewals", icon: <IconRenewals /> },
  { label: "Work Queue", href: "/ams/work-queue", icon: <IconWorkQueue /> },
]
